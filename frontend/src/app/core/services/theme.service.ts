...
export class ThemeService {
    ...
    /**
     * Colore primario: una versione più scura del colorTema (40% nero miscelato).
     * Usato per pulsanti e accenti che devono distinguersi dallo sfondo tema.
     */
     ...
     * 'dark' se il testo deve essere chiaro (sfondo scuro).
     * Usato come attributo `data-theme-tone` e `data-bs-theme` per Bootstrap.
     */
