...
- **Vendita di beni/servizi online** (Codice del Consumo, artt. 49 e seguenti — contratti a distanza): informazioni precontrattuali obbligatorie prima dell'ordine, e **diritto di recesso** di 14 giorni (pattern già pronto nella ricetta "Pagine legali" sopra, voce `extra` con `PageType.WithdrawalPolicy`) — verificane il dettaglio con un legale. Il link alla piattaforma ODR (Reg. UE 524/2013) **non è più richiesto** (abrogato dal Reg. UE 2024/3228, piattaforma dismessa dal 20/7/2025): se il tuo TOS ce l'ha da prima, va tolto.
